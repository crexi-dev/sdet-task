...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<crx-big-input-action></crx-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<crx-big-input-action [disabled]="true"></crx-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<crx-big-input-action fontSet="fas" fontIcon="trash"></crx-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<crx-big-input-action label="delete"></crx-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<crx-big-input-action (action)="actionHandler()"></crx-big-input-action>';
    fixture = createHostComponent(template);
